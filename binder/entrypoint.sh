...
update_cognitive_architecture() {
    ...
    # The ORM interfaces are tracked as empty placeholders and are not generated into
    # the image, so the first notebook cell generates them for whatever this pull left
    # in the checkout.
